...
<!--                            <div class="pnl-list" id="hists">&lt;!&ndash; 历史消息 &ndash;&gt;</div>-->
...
<!--                                        &lt;!&ndash; <div class="msg-host photo"-->
<!--                                            style="background-image: url(img/avatar/Member002.jpg)"></div> &ndash;&gt;-->
<!--                                        <div class="msg-ball">{{message.message}}</div>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
...
<!--                    //创建webSocket对象-->
<!--                    ws = new WebSocket("ws://localhost:5455/chat/"+this.name);-->
